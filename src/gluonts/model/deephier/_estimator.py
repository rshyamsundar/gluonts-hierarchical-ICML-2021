...
# Relative imports
from ._network import DeepHierPredictionNetwork, DeepHierTrainingNetwork
...
class DeepHierEstimator(DeepVAREstimator):
    """
    Constructs a DeepHier estimator, which is a hierachical extension of DeepAR.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert (
            not (coherent_pred_samples==False and coherent_train_samples==True)
    ...
    def create_training_network(self) -> DeepHierTrainingNetwork:
        return DeepHierTrainingNetwork(
            M=self.M,
            A=self.A,
